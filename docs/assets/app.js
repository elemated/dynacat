...
async function renderHome() {
  ...
  const docs = [
    ...
    { page: 'widget-editor', title: 'Widget Editor', desc: 'Build custom-api widgets visually, no template needed', icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="13" height="13" rx="2"/><path d="M3 7.5h13"/><path d="m12 12 9 3.2-3.6 1.2L16.2 20 12 12z"/></svg>` },
